...
During this milestone we created the template and mock pages for the application, and started to do research on what information we can have the chat-bot implement.
